function [e_rho,e_vel]=comput_minn_validation_cluster_pt_no_removed_data(day)
% if nargin<2 models = 2; resol = 1; proj = 1; end
if nargin<1 day = 27; end
clc;
resol = 7;
proj = 1;%or 2
   tic
...
%             % phase-transition
           load GPT_q_0419_no_removed_data;
           fd_pt1=func_rhoc(80.7744,para,93.7112,528.8386);



           u_r = 94.1755; rho_r = 1.0e+06*rhof; 
% %        rho_r = rhof;
