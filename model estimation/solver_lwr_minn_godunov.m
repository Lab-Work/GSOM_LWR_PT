function [erho,evel] = solver_lwr_minn_godunov(tfinal,pos,D,Vel,fd_eq,h,wm,rhom)
% function [erho,evel] = solver_lwr_minn_godunov(pos,D,Vel,fd_eq,h,wm,rhom)
...
%==========================================================================
% generate dx, and dt
p1 = fd_eq(1); p2 = fd_eq(2); p3 = fd_eq(3);
