...
for i =1:9
    if i~=7
        P_sort=sortrows(P,17+i);
        para(i,1)=P_sort(1,i);
        plot(grid,func_flux_creen_pt(grid,P_sort(1,i),rho_c,v_m,rho_m),'b-','linewidth',2.5),hold on
    else
