function P = gen_data_fd_minn_sensors_relax(rhom)
...
m = length(beta);
 P = zeros(m+2,2);  % initialize the matrix
% P = zeros(m,3);  % initialize the matrix
P(m+1,1) = sigma0;
P(m+1,2) = mu0;
P(m+2,1) = rhom0;
...
%  plot(grid,traffic_flux_smooth(grid,P(2,1),P(2,2),P(2,3),rho_m),'m-','linewidth',2.5), hold on
%  plot(grid,traffic_flux_smooth(grid,P(3,1),P(3,2),P(3,3),rho_m),'r-','linewidth',2.5), hold on
%  plot(grid,traffic_flux_smooth(grid,P(4,1),P(4,2),P(4,3),rho_m),'k-','linewidth',2.5), hold on
%  plot(grid,traffic_flux_smooth(grid,P(5,1),P(5,2),P(5,3),rho_m),'r-.','linewidth',2.5), hold on
%  plot(grid,traffic_flux_smooth(grid,P(6,1),P(6,2),P(6,3),rho_m),'m-.','linewidth',2.5), hold on
%  plot(grid,traffic_flux_smooth(grid,P(7,1),P(7,2),P(7,3),rho_m),'b-.','linewidth',2.5), hold on
%  plot(grid,traffic_flux_smooth(grid,P(8,1),P(8,2),P(8,3),rho_m),'k-.','linewidth',2.5), hold on
%  plot(grid,traffic_flux_smooth(grid,P(9,1),P(9,2),P(9,3),rho_m),'b--','linewidth',2.5), hold on 
...
% hold off
%--------------------------------------------------------
plot(grid,func_fd_seibold_2p(grid,P(1,1),P(1,2),rho0,v0,f0,uf,rhof,rho_m),'r--','linewidth',4),hold on
plot(grid,func_fd_seibold_2p(grid,P(2,1),P(2,2),rho0,v0,f0,uf,rhof,rho_m),'k-','linewidth',4), hold on
plot(grid,func_fd_seibold_2p(grid,P(3,1),P(3,2),rho0,v0,f0,uf,rhof,rho_m),'k-','linewidth',4), hold on
plot(grid,func_fd_seibold_2p(grid,P(4,1),P(4,2),rho0,v0,f0,uf,rhof,rho_m),'k-','linewidth',4), hold on
plot(grid,func_fd_seibold_2p(grid,P(5,1),P(5,2),rho0,v0,f0,uf,rhof,rho_m),'k-','linewidth',4), hold on
plot(grid,func_fd_seibold_2p(grid,P(6,1),P(6,2),rho0,v0,f0,uf,rhof,rho_m),'k-','linewidth',4), hold on
plot(grid,func_fd_seibold_2p(grid,P(7,1),P(7,2),rho0,v0,f0,uf,rhof,rho_m),'m-','linewidth',4), hold on
plot(grid,func_fd_seibold_2p(grid,P(8,1),P(8,2),rho0,v0,f0,uf,rhof,rho_m),'k-','linewidth',4), hold on
plot(grid,func_fd_seibold_2p(grid,P(9,1),P(9,2),rho0,v0,f0,uf,rhof,rho_m),'k-','linewidth',4), hold on
...
title('CGARZ','fontsize',14)%  title('Fitting to Smooth FDs W.R.T different \gamma','fontsize',14)
