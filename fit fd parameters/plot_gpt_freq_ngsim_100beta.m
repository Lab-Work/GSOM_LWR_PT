function plot_gpt_freq_ngsim_100beta
clear;
...
%         end
if iter==eq_id
    plot(grid,func_flux_creen_pt(grid,para(iter,1),rho_c,v_m,rho_m),'m-','linewidth',0.05),hold on
else
...
savefile = sprintf('GPT_q_0411-ngsim');
