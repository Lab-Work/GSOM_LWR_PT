function P = plot_cgarz_freq_ngsim_100beta_temp1
...
%         if P_sort(i,18+j)>P_sort(i+1,18+j)-10 && P_sort(i,18+j)<P_sort(i+1,18+j)+10
%             count=count+1;
...
savefile = sprintf('CGARZ_100beta_2para-ngsim_updated-0516-noshrink');
% savefile = sprintf('data_fd_minn_garz');
% 
save(savefile,'P2');    % P is the parameters, n cross 3

savefile = sprintf('CGARZ_eq_6para-ngsim_updated-0516-noshrink');
% savefile = sprintf('data_fd_minn_garz');
% 
