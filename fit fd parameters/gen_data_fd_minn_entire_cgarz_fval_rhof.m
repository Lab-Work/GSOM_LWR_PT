function P = gen_data_fd_minn_entire_cgarz_fval_rhof
...
ub = [1000,1000,1000,1000,1000,1000,100,150,2000,1000]; 
            ...
            for iter4 =1:N4
                for iter5=1:N5
                    for iter6=1:N6
                        ...
                        [x,fval] = fmincon(@(x) ((1/(3*max(length(density))))*(beta(9)*(norm(max((func_fd_seibold_2p_updated(density,x(1),x(2),x(7),x(8),x(9),x(10))...
                            ...
                            -flux),0*flux)))^2))^(0.5)-0.3*x(7),x0,[],[],[],[],lb,ub);%CGARZ!!!
