function P = gen_data_fd_ngsim_entire_cgarz_fval_shrink
                ...
                for iter5=1:N5
                    for iter6=1:N6
                        ...
                        [x,fval] = fmincon(@(x) beta(9)*(norm(max(shrinkage(density,(func_fd_seibold_2p_updated(density,x(1),x(2),x(7),x(8),x(9),x(10))...
                            ...
                            -flux),x(7),tau),0*flux)))^2,x0,[],[],[],[],lb,ub);%CGARZ!!!
...
savefile = sprintf('CGARZ_entire_fval-rhof-1-ngsim-0125-tau1200');
...
savefile = sprintf('CGARZ_entire_fval-rhof-2-ngsim-0125-tau1200');
% savefile = sprintf('data_fd_minn_garz');
% 
